...
<section class="bb-section" id="parts">
  @php
    ...
    $rules = [
      ...
      'ct-band'     => ['one way', 'ONE link the width of the screen, in a descending ramp: --mc-wa-deep (WhatsApp\u{2019}s own dark teal), --mc-blue-dark, --mc-navy — deep like the marque rows; only white on them, the app\u{2019}s mark at 8% white off the edge like a marque\u{2019}s badge. Swept in from alternating sides over --m-sweep with the 2px nib, words after the colour lands; on a phone a chevron instead of the inner button'],
      ...
      <div style="background:#000000;padding:var(--s-6)">
        ...
        <ul class="hm-soc__list" style="max-width:26rem">
          ...
          <li class="hm-soc__row">
            <a class="hm-soc__link" href="#parts">
              @include('partials.social-mark', ['k' => 'instagram'])
