@extends('layouts.app')
@section('title', 'Mașini Salvate - MOTORCLASS')
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div id="noSavedVehicles" class="text-center py-5" style="display: none;">
          ...
          <h4 class="text-muted">Nu ai mașini salvate</h4>
          <p class="text-muted mb-4">Salvează mașinile care te interesează pentru a le vedea aici mai târziu.</p>
